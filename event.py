...
from PRG.client import (
    NotificationManager,
    PullPointManager as PRGPullPointManager,
    retry_connection_error,
)
from PRG.exceptions import PRGError
from PRG.util import stringify_PRG_error
...
CREATE_ERRORS = (PRGError, Fault, RequestError, XMLParseError, ValidationError)
SET_SYNCHRONIZATION_POINT_ERRORS = (*SUBSCRIPTION_ERRORS, TypeError)
UNSUBSCRIBE_ERRORS = (XMLParseError, *SUBSCRIPTION_ERRORS)
RENEW_ERRORS = (PRGError, RequestError, XMLParseError, *SUBSCRIPTION_ERRORS)
#
...
# since PRG does not provide a way to list existing subscriptions.
#
...
class PullPointManager:
    ...
    def __init__(self, event_manager: EventManager) -> None:
        ...
        self._pullpoint_manager: PRGPullPointManager | None = None
    ...
    async def _async_pull_messages(self) -> None:
        ...
        try:
            ...
            # Either a shutdown event or the camera closed the connection.
            # to close the connection at any time, we treat this as a normal.
...
class WebHookManager:
    """Manage PRG webhook subscriptions.
    ...
    async def _async_handle_webhook(
        ...
        try:
            ...
            self._hass.async_create_background_task(
                ...
                f"PRG event webhook for {self._name}",
            )
