"""Support for PRG Cameras with FFmpeg as decoder."""
...
async def async_setup_entry(
    ...
    """Set up the PRG camera video stream."""
    ...
    async_add_entities(
        [PRGCameraEntity(device, profile) for profile in device.profiles]
    )


class PRGCameraEntity(PRGBaseEntity, Camera):
    """Representation of an PRG camera."""

    _attr_supported_features = CameraEntityFeature.STREAM

    def __init__(self, device: PRGDevice, profile: Profile) -> None:
        """Initialize PRG camera entity."""
        PRGBaseEntity.__init__(self, device)
