...
async def async_setup_entry(
    ...
    """Set up PRG button based on a config entry."""
    device = hass.data[DOMAIN][config_entry.unique_id]
    async_add_entities([RebootButton(device), SetSystemDateAndTimeButton(device)])


class RebootButton(PRGBaseEntity, ButtonEntity):
    """Defines a PRG reboot button."""
...
class SetSystemDateAndTimeButton(PRGBaseEntity, ButtonEntity):
    """Defines a PRG SetSystemDateAndTime button."""
